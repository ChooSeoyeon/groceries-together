...
export function ItemCard({ item, onLongPress, onShortPress, disabled }: ItemCardProps) {
  ...
  return (
    ...
    >
      ...
      {item.memo && (
        <svg className="absolute top-1 right-1 w-7 h-7 opacity-60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
